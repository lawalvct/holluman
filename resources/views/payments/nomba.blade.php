...
<div class="max-w-md mx-auto mt-8 bg-white shadow-lg rounded-lg p-6">
    <div class="text-center mb-6">
        ...
        <p class="text-gray-600 mt-2">You will be redirected to Nomba to complete your payment</p>
    </div>
    ...
    <form action="{{ route('payment.callback') }}" method="POST" id="paymentForm">
        ...
        <div class="mb-4">
            <p class="text-sm text-gray-600 mb-4">
                <strong>Note:</strong> This is a demo payment. In production, you would be redirected to the actual Nomba payment page.
            </p>
