            ...
            <form action="{{ route('wallet.fund') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center">
                            <input type="radio" name="gateway" value="nomba" class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300">
                            <span class="ml-2 text-sm text-gray-700">Nomba</span>
                        </label>
                    </div>
                </div>
